...
public class AS2ClientConnection {
    ...
    public AS2ClientConnection(String as2Version, String userAgent, String clientFqdn, String targetHostName, Integer targetPortNumber, String targetSchema) throws UnknownHostException, IOException {
        ...
        this.targetHost = new HttpHost(Args.notNull(targetHostName, "targetHostName"), 
                Args.notNull(targetPortNumber, "targetPortNumber"),
                Args.notNull(targetSchema, "targetSchema"));
