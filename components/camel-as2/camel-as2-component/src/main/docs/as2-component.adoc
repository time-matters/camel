...
| *compressionAlgorithm* (common) | The algorithm used to compress the message. The value can be one of: ZLIB |  | AS2CompressionAlgorithm
| *decryptingPrivateKey* (common) | The key used to encrypt the the message. |  | PrivateKey
...
| *encryptingAlgorithm* (common) | The algorithm used to encrypt the message. The value can be one of: AES128_CBC, AES192_CBC, AES256_CBC, AES128_CCM, AES192_CCM, AES256_CCM, AES128_GCM, AES192_GCM, AES256_GCM, CAMELLIA128_CBC, CAMELLIA192_CBC, CAMELLIA256_CBC, CAST5_CBC, DES_CBC, DES_EDE3_CBC, GOST28147_GCFB, IDEA_CBC, RC2_CBC, RC4, SEED_CBC |  | AS2EncryptionAlgorithm
| *encryptingCertificateChain* (common) | The chain of certificates used to encrypt the message. |  | Certificate[]
...
| *messageTransferEncoding* (common) | The transfer encoding of the message. |  | String
| *messageType* (common) | The content type of the message. One of application/edifact, application/edi-x12, application/edi-consent, application/xml |  | ContentType
| *requestUri* (common) | The request URI. | / | String
...
| *targetSchema* (common) | the scheme to use for the http connection | http | String
